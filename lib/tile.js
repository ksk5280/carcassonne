...
class Tile {
  ...
  buildDom() {
    ...
    this.dom.css('background-image', `url('lib/images/tiles/${this.type}.png')`);
  ...
  get position() {
    ...
    let x = Math.round(this.dom.position().left / 10 ) * 10;
    let y = Math.round(this.dom.position().top / 10 ) * 10;
    return {x, y}
  }
